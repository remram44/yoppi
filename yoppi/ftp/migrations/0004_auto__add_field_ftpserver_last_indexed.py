...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FtpServer.last_indexed'
        db.add_column('ftp_ftpserver', 'last_indexed',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FtpServer.last_indexed'
        db.delete_column('ftp_ftpserver', 'last_indexed')
